...
public class Taker {
    ...
    public TestSessions getTestSessions() {
        return testSessions;
    }

    public void setTestSessions(TestSessions testSessions) {
    ...
    public String toString() {
        return "Taker{" + "takerId=" + takerId + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", phone=" + phone + ", age=" + age + ", gender=" + gender + ", instagramAccount=" + instagramAccount + ", createdDate=" + createdDate + ", createdBy=" + createdBy + ", lastModifiedDate=" + lastModifiedDate + ", lastModifiedBy=" + lastModifiedBy + ", referredBy=" + referredBy + ", questionResponses=" + questionResponses + ", testSessions=" + testSessions + ", zipCode=" + zipCode + ", medicalProfessional=" + medicalProfessional + ", covid=" + covid + ", password=" + password + ", confirmPassword=" + confirmPassword + '}';
    }
