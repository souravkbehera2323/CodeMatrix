        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" modelAttribute="question" method="POST" name="form1" id="form1" action="../question/submitQuestion.htm">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group" id="questionOptionsDiv">                                        
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <form:select path="questionOptions" cssClass="select form-control" items="${questionOptionList}" itemLabel="questionOptionName" itemValue="questionOptionId" multiple="true"/>
