    ...
    <head>
        ...
        <script>
            ...
            function checkPassword() {
                document.getElementById("form1").action='../home/updateExpiredPassword.htm';
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-footer">
                                        <div class="pull-right">
                                            ...
                                            <button type="submit" name="_cancel" class="btn btn-primary" onclick="document.getElementById('form1').action='../logout';">Logout</button>
                                        </div>
                                    </div>
                                </div>
                            </form:form>
